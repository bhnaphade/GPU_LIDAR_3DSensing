...
GPUCMD1 = "nvcc -I/usr/local/cuda/include -I. -L/usr/local/cuda/lib64 -c -lineinfo -arch=sm_53 -g -o temp.o  cudaImageTransformation.cu"
GPUCMD2 = "nvcc -dlink -o gpuExecutableFunctions.o temp.o -lcuda -lcudart"
